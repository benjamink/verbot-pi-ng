...
| `VERBOT_INTERROGATION_SPEED` | `85` | Drum speed. Bracketed from both sides - too slow stalls the drum, too fast overshoots a switch before the motor finishes reversing and lands on the next one round. |
